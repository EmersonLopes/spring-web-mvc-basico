package com.example.springwebmvcbasico.controller;

import com.example.springwebmvcbasico.model.Jedi;
import com.example.springwebmvcbasico.repository.JediRepository;
...
public class JediController {
    ...
    public ModelAndView jedi() {
        ...
        modelAndView.addObject("allJedi", jediRepository.listAll());
        return modelAndView;
    }
